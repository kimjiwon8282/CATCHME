...
router.route('/memberinfo/more/setting/updatepassword').post(requireLogin, updatePassword);//로그인 검사후 패시워드 업데이트
router.route('/memberinfo/more/setting/memberdelete').delete(requireLogin, deleteUser); //로그인 검사후 회원탈퇴
